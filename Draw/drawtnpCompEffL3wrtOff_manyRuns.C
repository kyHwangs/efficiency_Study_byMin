...
void drawtnpCompEffL3wrtOff_manyRuns(
  TString efftag = "IsoMu24", TString ver = "vRun3_05", TString SAMPLE = "Run2022", TString tag = "Muon",
  ...
  vector<TString> types = {
    "Eff/"+efftag+"/num_Eff"+L1tag+"_"+efftag+"_Run360991_360991",
    "Eff/"+efftag+"/num_Eff"+L1tag+"_"+efftag+"_Run361468_361468",
    "Eff/"+efftag+"/num_Eff"+L1tag+"_"+efftag+"_Run362437_362437",
    //"Eff/"+efftag+"/num_Eff"+L1tag+"_"+efftag+"_Run362438_362438",
    //"Eff/"+efftag+"/num_Eff"+L1tag+"_"+efftag+"_Run362439_362439",
    "Eff/"+efftag+"/num_Eff"+L1tag+"_"+efftag+"_Run362616_362618",
  };
  vector<TString> types_den = {
    "Eff/"+efftag+"/den_Eff"+L1tag+"_"+efftag+"_Run360991_360991",
    "Eff/"+efftag+"/den_Eff"+L1tag+"_"+efftag+"_Run361468_361468",
    "Eff/"+efftag+"/den_Eff"+L1tag+"_"+efftag+"_Run362437_362437",
    //"Eff/"+efftag+"/den_Eff"+L1tag+"_"+efftag+"_Run362438_362438",
    //"Eff/"+efftag+"/den_Eff"+L1tag+"_"+efftag+"_Run362439_362439",
    "Eff/"+efftag+"/den_Eff"+L1tag+"_"+efftag+"_Run362616_362618",
  };
  ...
  for(unsigned i_eta=0; i_eta<etas_str.size(); i_eta++){
	...
	if(!v_var[ivar].Contains("pt") || v_var[ivar] == "pt_zoom") {
	  ymin = 0.6;//0.85;//0.6;//0.85;
	  ymax = 1.2;//1.1;//1.2;//1.1;
	}
