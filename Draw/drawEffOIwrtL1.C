...
// echo 'gROOT->LoadMacro("drawEffOIwrtL1.C+"); gSystem->Exit(0);' | root -b -l
// rootbq 'drawEffOIwrtL1.C("v01", "DY Winter21", "DYToLL_M50", "L1Tk")'
// rootbq 'drawEffOIwrtL1.C("v01", "DY Winter21", "DYToLL_M50", "")'
...
void drawEffOIwrtL1(
  ...
  vector<TString> types_str = {
    "OI: IO patatrack WP 0",
    "OI: IO patatrack WP 0.01",
    "OI: IO patatrack WP 0 + OI upg.",
    "OI: IO patatrack WP 0.01 + OI upg.",
  };
