...
void drawtnpCompEffL3wrtL1_chaining(
  TString efftag = "hltIterL3Muon", bool gen = false, TString ver = "vRun3_07", TString SAMPLE = "Run2024C Muon0", TString tag = "Muon0",
  ...
  vector<TString> files = {
    "./Outputs_"+ver+"/hist-"+ver+"-"+tag+"_Run2024C-"+Eff+".root",
    "./Outputs_"+ver+"/hist-"+ver+"-chaining-"+tag+"_Run2024C-"+Eff+".root",
    "./Outputs_"+ver+"/hist-"+ver+"-chaining_v2-"+tag+"_Run2024C-"+Eff+".root",
