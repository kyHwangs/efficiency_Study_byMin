...
// echo 'gROOT->LoadMacro("drawEffCompL3MuonwrtL1.C+"); gSystem->Exit(0);' | root -b -l
// rootbq 'drawEffCompL3MuonwrtL1.C("v01", "DY Winter21", "DYToLL_M50", "L1Tk")'
// rootbq 'drawEffCompL3MuonwrtL1.C("v01", "DY Winter21", "DYToLL_M50", "")'

void drawEffCompL3MuonwrtL1(
  TString ver = "v1", TString SAMPLE = "DY", TString tag = "DYToLL_M50",
  ...
  vector<TString> files = {
    ...
    "./Outputs_"+ver+"/hist-"+ver+"-wp00_OI-"+tag+"-Eff"+file_tag+".root",
    "./Outputs_"+ver+"/hist-"+ver+"-wp01_OI-"+tag+"-Eff"+file_tag+".root",
    // "./Outputs_"+ver+"/hist-"+ver+"-wp00-"+tag+"-Eff"+file_tag+".root",
    // "./Outputs_"+ver+"/hist-"+ver+"-wp01-"+tag+"-Eff"+file_tag+".root",
  };

  vector<TString> types = {
    "Eff/num_Eff_"+L1tag+"_hltIterL3MuonNoID",
    "Eff/num_Eff_"+L1tag+"_hltIterL3MuonNoID",
    "Eff/num_Eff_"+L1tag+"_hltIterL3MuonNoID",
    "Eff/num_Eff_"+L1tag+"_hltIterL3MuonNoID",
  };
  ...
  vector<TString> types_den = {
    "Eff/den_Eff_"+L1tag+"_hltIterL3MuonNoID",
    "Eff/den_Eff_"+L1tag+"_hltIterL3MuonNoID",
    "Eff/den_Eff_"+L1tag+"_hltIterL3MuonNoID",
    "Eff/den_Eff_"+L1tag+"_hltIterL3MuonNoID",
  };
  ...
  vector<TString> types_str = {
    "L3 muons before ID: IO patatrack WP 0",
    "L3 muons before ID: IO patatrack WP 0.01",
    "L3 muons before ID: IO patatrack WP 0 + OI upg.",
    "L3 muons before ID: IO patatrack WP 0.01 + OI upg.",
  };
