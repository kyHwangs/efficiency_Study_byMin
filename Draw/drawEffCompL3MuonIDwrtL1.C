...
// echo 'gROOT->LoadMacro("drawEffCompL3MuonIDwrtL1.C+"); gSystem->Exit(0);' | root -b -l
// rootbq 'drawEffCompL3MuonIDwrtL1.C("v01", "DY Winter21", "DYToLL_M50", "L1Tk")'
// rootbq 'drawEffCompL3MuonIDwrtL1.C("v01", "DY Winter21", "DYToLL_M50", "")'
...
void drawEffCompL3MuonIDwrtL1(
  ...
  vector<TString> types = {
    "Eff/num_Eff_"+L1tag+"_hltIterL3Muon",
    "Eff/num_Eff_"+L1tag+"_hltIterL3Muon",
    "Eff/num_Eff_"+L1tag+"_hltIterL3Muon",
    "Eff/num_Eff_"+L1tag+"_hltIterL3Muon",
    "Eff/num_Eff_"+L1tag+"_hltIterL3Muon",
  ...
  vector<TString> types_den = {
    "Eff/den_Eff_"+L1tag+"_hltIterL3Muon",
    "Eff/den_Eff_"+L1tag+"_hltIterL3Muon",
    "Eff/den_Eff_"+L1tag+"_hltIterL3Muon",
    "Eff/den_Eff_"+L1tag+"_hltIterL3Muon",
    "Eff/den_Eff_"+L1tag+"_hltIterL3Muon",
  ...
  vector<TString> types_str = {
    "L3 muons after ID: Run 3 baseline",
    "L3 muons after ID: IO patatrack.",
    "L3 muons after ID: IO patatrack + IO upg.",
    "L3 muons after ID: IO patatrack (ROI#times1.5^{2})",
    "L3 muons after ID: IO patatrack (ROI#times1.5^{2}) + IO upg.",
    "L3 muons after ID: IO patatrack (ROI#times2^{2})",
    "L3 muons after ID: IO patatrack (ROI#times2^{2}) + IO upg.",
  };
