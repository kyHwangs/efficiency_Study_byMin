...
// echo 'gROOT->LoadMacro("drawEffIOFromL1wrtL1.C+"); gSystem->Exit(0);' | root -b -l
// rootbq 'drawEffIOFromL1wrtL1.C("v01", "DY Winter21", "DYToLL_M50", "L1Tk")'
// rootbq 'drawEffIOFromL1wrtL1.C("v01", "DY Winter21", "DYToLL_M50", "")'

void drawEffIOFromL1wrtL1(
  ...
  vector<TString> files = {
    "./Outputs_"+ver+"/hist-"+ver+"-wp00_NoOI-"+tag+"-Eff"+file_tag+".root",
  ...
  vector<TString> types = {
    ...
    "Eff/num_Eff_"+L1tag+"_hltFromL1Merged",
    "Eff/num_Eff_"+L1tag+"_hltIter2FromL1",
    "Eff/num_Eff_"+L1tag+"_hltIter2FromL1",
  };
  ...
  vector<TString> types_den = {
    ...
    "Eff/den_Eff_"+L1tag+"_hltFromL1Merged",
    "Eff/den_Eff_"+L1tag+"_hltIter2FromL1",
    "Eff/den_Eff_"+L1tag+"_hltIter2FromL1",
  };
  ...
  vector<TString> types_str = {
    ...
    "IO(L1): OI upg.",
    "IO(L1): OI upg. + IO patatrack",
    "IO(L1): OI upg. + IO patatrack + IO upg.",
  };
