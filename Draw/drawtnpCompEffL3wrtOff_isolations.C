...
void drawtnpCompEffL3wrtOff_isolation(
  ...
  TString Dir = "./plots_"+ver+"_isolations/"+tag+"/"+Eff+"/"+efftag+"/";
  ...
  vector<TString> types = {
    ...
    "Eff/ECALIso"+efftag+"/num_Eff_ECALIso"+efftag+run,
    "Eff/HCALIso"+efftag+"/num_Eff_HCALIso"+efftag+run,
    "Eff/Iso"+efftag+"/num_Eff_Iso"+efftag+run,
    "Eff/"+efftag+"/num_Eff_"+efftag+run,
  ...
  vector<TString> types_den = {
    ...
    "Eff/ECALIso"+efftag+"/den_Eff_ECALIso"+efftag+run,
    "Eff/HCALIso"+efftag+"/den_Eff_HCALIso"+efftag+run,
    "Eff/Iso"+efftag+"/den_Eff_Iso"+efftag+run,
    "Eff/"+efftag+"/den_Eff_"+efftag+run,
  ...
  vector<TString> types_str = {
    ...
    "ECAL Isolation",
    "ECAL+HCAL Isolation",
    "ECAL+HCAL+Tracker Isolation = IsoMu24",
  };
