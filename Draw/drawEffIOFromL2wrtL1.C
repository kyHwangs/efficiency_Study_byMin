...
// echo 'gROOT->LoadMacro("drawEffIOFromL2wrtL1.C+"); gSystem->Exit(0);' | root -b -l
// rootbq 'drawEffIOFromL2wrtL1.C("v01", "DY Winter21", "DYToLL_M50", "L1Tk")'
// rootbq 'drawEffIOFromL2wrtL1.C("v01", "DY Winter21", "DYToLL_M50", "")'
...
void drawEffIOFromL2wrtL1(
  ...
  vector<TString> types = {
    "Eff/num_Eff_"+L1tag+"_hltIOFromL2Merged",
    "Eff/num_Eff_"+L1tag+"_hltIOFromL2Merged",
    "Eff/num_Eff_"+L1tag+"_hltIter2",
    "Eff/num_Eff_"+L1tag+"_hltIter2",
  };

  vector<TString> types_den = {
    "Eff/den_Eff_"+L1tag+"_hltIOFromL2Merged",
    "Eff/den_Eff_"+L1tag+"_hltIOFromL2Merged",
    "Eff/den_Eff_"+L1tag+"_hltIter2",
    "Eff/den_Eff_"+L1tag+"_hltIter2",
  };

  vector<TString> types_str = {
    "IO(L2): Run 3 baseline",
    "IO(L2): OI upg.",
    "IO(L2): OI upg. + IO patatrack",
    "IO(L2): OI upg. + IO patatrack + IO upg.",
  };
