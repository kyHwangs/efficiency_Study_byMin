...
// echo 'gROOT->LoadMacro("drawEffL3FromL2wrtL1.C+"); gSystem->Exit(0);' | root -b -l
// rootbq 'drawEffL3FromL2wrtL1.C("v01", "DY Winter21", "DYToLL_M50", "L1Tk")'
// rootbq 'drawEffL3FromL2wrtL1.C("v01", "DY Winter21", "DYToLL_M50", "")'

void drawEffL3FromL2wrtL1(
  ...
  vector<TString> types_den = {
    "Eff/den_Eff_"+L1tag+"_hltL3FromL2Merged",
    "Eff/den_Eff_"+L1tag+"_hltL3FromL2Merged",
    "Eff/den_Eff_"+L1tag+"_hltL3FromL2Merged",
    "Eff/den_Eff_"+L1tag+"_hltL3FromL2Merged",
    "Eff/den_Eff_"+L1tag+"_hltL3FromL2Merged",
  ...
  vector<TString> types_str = {
    "OI + IO(L2): Run 3 baseline",
    "OI + IO(L2): IO patatrack",
    "OI + IO(L2): IO patatrack + IO upg.",
    "OI + IO(L2): IO patatrack (ROI#times1.5^{2})",
    "OI + IO(L2): IO patatrack (ROI#times1.5^{2}) + IO upg.",
    "OI + IO(L2): IO patatrack (ROI#times2^{2})",
    "OI + IO(L2): IO patatrack (ROI#times2^{2}) + IO upg.",
  };
