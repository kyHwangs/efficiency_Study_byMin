...
// echo 'gROOT->LoadMacro("drawEffL2wrtL1.C+"); gSystem->Exit(0);' | root -b -l
// rootbq 'drawEffL2wrtL1.C("v01", "DY Winter21", "DYToLL_M50", "L1Tk")'
// rootbq 'drawEffL2wrtL1.C("v01", "DY Winter21", "DYToLL_M50", "")'
...
void drawEffL2wrtL1(
  ...
  vector<TString> types_str = {
    "L2 muon: Run 3 baseline",
    "L2 muon: IO patatrack",
    "L2 muon: IO patatrack + IO upg.",
    "L2 muon: IO patatrack (ROI#times1.5^{2})",
    "L2 muon: IO patatrack (ROI#times1.5^{2}) + IO upg.",
    "L2 muon: IO patatrack (ROI#times2^{2})",
    "L2 muon: IO patatrack (ROI#times2^{2}) + IO upg.",
  };
