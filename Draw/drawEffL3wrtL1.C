...
// echo 'gROOT->LoadMacro("drawEffL3wrtL1.C+"); gSystem->Exit(0);' | root -b -l
// rootbq 'drawEffL3wrtL1.C("v01", "DY Winter21", "DYToLL_M50", "L1Tk")'
// rootbq 'drawEffL3wrtL1.C("v01", "DY Winter21", "DYToLL_M50", "")'
...
void drawEffL3wrtL1(
  ...
  vector<TString> types_den = {
    ...
    "Eff/den_Eff_"+L1tag+"_hltL3Merged",
    "Eff/den_Eff_"+L1tag+"_hltL3Merged",
  };
