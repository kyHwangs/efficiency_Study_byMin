...
// echo 'gROOT->LoadMacro("drawEffL3MuonwrtL1.C+"); gSystem->Exit(0);' | root -b -l
// rootbq 'drawEffL3MuonwrtL1.C("v01", "DY Winter21", "DYToLL_M50", "L1Tk")'
// rootbq 'drawEffL3MuonwrtL1.C("v01", "DY Winter21", "DYToLL_M50", "")'

void drawEffL3MuonwrtL1(
