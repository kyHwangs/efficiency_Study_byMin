...
plots_folder="plots_vRun3_09/Muon/"
web_path="/eos/user/w/wjun/www/Run2024_MuonHLT/240704_MuonHLT_forSTEAM"
rm -rf $web_path
mkdir $web_path
...
#root -l -b -q 'drawtnpCompEffL3wrtL1_ratio.C("hltIter03FromL1Merged")'
